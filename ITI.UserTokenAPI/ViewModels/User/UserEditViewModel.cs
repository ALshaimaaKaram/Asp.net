...
namespace ViewModels
{
    ...
    {
        public static ITI.UserTokenAPI.Models.User ToModel(this UserEditViewModel UserEditViewModel)
        {
            return new ITI.UserTokenAPI.Models.User()
            {
        ...
        public static UserEditViewModel ToEditableModel(this ITI.UserTokenAPI.Models.User User)
        {
